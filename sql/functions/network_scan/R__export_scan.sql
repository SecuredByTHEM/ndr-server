...
BEGIN
    ...
    FOR host_address IN SELECT * FROM network_scan.flattened_host_addresses WHERE scan_id=_scan_id
    LOOP
        DECLARE
        ...
        BEGIN
            ...
            host_json_array := array_append(host_json_array, json_build_object(
