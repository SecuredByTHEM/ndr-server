-- Checks if a user is allowed to access a given recorder
--
-- Raises exception if not true

CREATE OR REPLACE FUNCTION webui.check_recorder_acl(_user_id bigint, _recorder_id bigint) RETURNS boolean
